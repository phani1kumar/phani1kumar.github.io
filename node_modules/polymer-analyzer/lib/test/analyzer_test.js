...
suite('Analyzer', () => {
    ...
    suite('analyze()', () => {
        ...
        test('creates a document warning when a behavior cannot be found in that document', () => __awaiter(this, void 0, void 0, function* () {
            let document = yield analyzer.analyze('static/html-missing-behaviors.html');
        ...
        test('creates "missing behavior" warnings on imported documents without elements', () => __awaiter(this, void 0, void 0, function* () {
            let document = yield analyzer.analyze('static/chained-missing-behavior/index.html');
            let chainedDocument = document.getOnlyAtId('document', 'static/chained-missing-behavior/chained.html');
            let expectedWarning = {
                code: 'unknown-polymer-behavior',
